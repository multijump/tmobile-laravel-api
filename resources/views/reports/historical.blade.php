...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <p>A .csv file with all historical data will be sent to {{ \Auth::user()->email }}. To proceed please select date range and click Generate Report below. To pull complete data, leave date range blank. It may take a few minutes for the email to come through.</p>
            <br>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center">
                <form action="{{ route('reports.historical.generate') }}" method="POST" class="form">
                    @csrf
